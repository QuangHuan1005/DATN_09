            ...
            <div class="kitify-menu-account__box" style="position: relative;">
                ...
                @guest
                    <div class="user-menu" style="position: relative; display: inline-block;">
                        <span class="kitify-menu-account__icon kitify-blocks-icon user-icon" style="cursor: pointer;">
                ...
                <div class="user-menu" style="position: relative; display: flex; align-items: center; gap: 8px;">
                    <div class="user-greeting" style="display: flex; align-items: center; gap: 6px; white-space: nowrap;">
                        <span style="font-size: 16px;">👋</span>
                        <span style="font-size: 15px;">Xin chào,</span>
                        <strong style="font-size: 15px; text-transform: uppercase;">{{ Str::afterLast(Auth::user()->name, ' ') }}</strong>
                    </div>
