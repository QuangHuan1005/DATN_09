<nav class="sidebar">
  ...
  <div class="sidebar-avatar" style="text-align: center; margin-bottom: 20px;">
    <img src="{{ auth()->user()->image ?? 'https://via.placeholder.com/80' }}"
         alt="Avatar"
  ...
  <a href="{{ route('admin.products.variants') }}" class="{{ request()->routeIs('admin.products.variants*') ? 'active' : '' }}">
  ...
  {{-- Sản phẩm --}}
  <a href="{{ route('admin.products.index') }}" class="{{ request()->routeIs('admin.products.*') && !request()->routeIs('admin.products.variants*') ? 'active' : '' }}">
