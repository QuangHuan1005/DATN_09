...
@section('content')
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css"
        integrity="sha512-1ycn6IcaQQ401Wau+RTOyfaD34u+zP1o3L6dJ8QW4hL5Xv8t7b8b/9Q8B5wB0/S4eM5Vd7x+Q3qQ4v8w=="
    ...
    <body
        ...
        @if (session('success'))
            <div id="flash-message" class="toast-alert success center-top">
                <span class="toast-icon"><i class="fas fa-check-circle"></i></span>

                <span class="toast-message">{{ session('success') }}</span>
                <button class="toast-close" onclick="document.getElementById('flash-message').remove()">×</button>
            </div>
        @endif
                                        ...
                                        <div class="kitify-tabs kitify-tabs-style-default kitify-tabs-position-top kitify-tabs-move-up-effect tab-as-dropdown"
                                            ...
                                            <div class="kitify-tabs__content-wrapper">
                                                                                                ...
                                                                                                <div class="product-item">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <a class="product-item-link"
                                                                                                            href="{{ route('products.show', $item->id) }}"></a>
                                                                                                        <div
                                                ...
                                                <div id="kitify-tabs-content-2452" class="kitify-tabs__content "
                                                    data-tab="2">
                                                    <div data-kitify_ajax_loadtemplate="true" data-template-id="1090">
                                                        <span class="kitify-css-loader"></span>
                                                    </div>
                                                </div>
                                                <div id="kitify-tabs-content-2453" class="kitify-tabs__content "
                                                    data-tab="3">
                                                    <div data-kitify_ajax_loadtemplate="true" data-template-id="1073">
                                                        <span class="kitify-css-loader"></span>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <defs>
                        ...
                        <symbol id="mixtas-video-play" viewBox="0 0 70 70" xmlns="http://www.w3.org/2000/svg">
                            <g fill="none" fill-rule="evenodd" transform="translate(1.913 1.26)">
                                ...
                                <circle cx="33.087" cy="33.739" r="33" stroke="currentColor"
                                    stroke-width="4" />
                            </g>
                        </symbol>
