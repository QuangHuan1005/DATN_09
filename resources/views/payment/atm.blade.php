...
<body>
        ...
        <div class="left-panel">
            ...
            <div class="panel-content">
                ...
                <div class="cancel-link">
                    <a href="{{ route('checkout.index') }}">✕ Hủy giao dịch</a>
                </div>
            </div>
        </div>
            ...
            <div class="panel-content">
                <div class="order-info">
                    ...
                    <div class="order-item">
                        ...
                        <span class="order-amount">{{ number_format(session('pending_order.totalAmount', 0)) }} VND</span>
                    </div>
                </div>
    ...
    <script>
        ...
        function processPayment() {
            ...
            fetch('{{ route("payment.atm.process") }}', {
                method: 'POST',
                body: formData
            })
