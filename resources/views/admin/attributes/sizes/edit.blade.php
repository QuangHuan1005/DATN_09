    ...
    <div class="container-xxl">
        <div class="row">
            <div class="col-xl-8 col-lg-10 mx-auto">
                <form action="{{ route('admin.attributes.sizes.update', $size->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Chỉnh Sửa Kích Thước: {{ $size->name }}</h4>
                        </div>
                        <div class="card-body">
                            {{-- Thông báo lỗi --}}
                            @if ($errors->any())
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="size_code" name="size_code" 
                                            ...
                                            value="{{ old('size_code', $size->size_code) }}" 
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" 
                                            ...
                                            <option value="active" {{ old('status', $size->status) == 'active' ? 'selected' : '' }}>Hoạt động</option>
                                            <option value="inactive" {{ old('status', $size->status) == 'inactive' ? 'selected' : '' }}>Không hoạt động</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" 
                                            value="{{ $size->variants()->count() }} biến thể" 
                                            readonly disabled>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-0">
                                        ...
                                        <textarea class="form-control bg-light-subtle" name="description" 
                                            ...
                                            placeholder="Mô tả về kích thước (tùy chọn)">{{ old('description', $size->description) }}</textarea>
                                        @error('description')
