                                                                ...
                                                                @foreach ($orders as $order)
                                                                    ...
                                                                    <tr class="woocommerce-orders-table__row order">
                                                                        <th class="woocommerce-orders-table__cell woocommerce-orders-table__cell-order-number"
                                                                            ...
                                                                            @php
                                                                                $hasRefundedReturn = \App\Models\OrderReturn::where('order_id', $order->id)
                                                                                                           ->where('status', 'refunded')
                                                                                                           ->exists();
                                                                                $routeName = $hasRefundedReturn ? 'orders.refunded.show' : 'orders.show';
                                                                            @endphp
                                                                            <a href="{{ route($routeName, $order->id) }}"
