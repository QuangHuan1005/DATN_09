                                                        ...
                                                        <div id="nova-register-form" class="cell large-4">
                                                            ...
                                                            <form method="post"
                                                                ...
                                                                <div class="woocommerce-privacy-policy-text">
                                                                    <p>Dữ liệu cá nhân của bạn sẽ được sử dụng để hỗ trợ
                                                                        trải nghiệm của bạn trên trang web này, để quản
                                                                        lý quyền truy cập vào tài khoản của bạn và cho
                                                                        <a href="../index3b72.html?page_id=3"
                                                                ...
                                                                <p class="form-actions">
                                                                    <input type="hidden" id="woocommerce-register-nonce"
                                                                        ...
                                                                        value="4f4142dc15" /><input type="hidden"
                                                                        name="_wp_http_referer" value="/my-account/" />
                                                                    <button type="submit"
                                                                        class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit"
                                                                        name="register" value="Register">Đăng
                                                                        ký</button>
                                                                </p>
                                                                <p class="form-actions-extra">Đã có tài khoản?<a
                                                                        href="{{ route('login') }}"
                                                                        class="login-control"> Đăng nhập</a></p>
