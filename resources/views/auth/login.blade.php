        ...
        <div class="site-wrapper">
                                                        ...
                                                        <div class="nova-form-container grid-x grid-padding-x">
                                                            ...
                                                            <div id="nova-login-form" class=" cell large-4">
                                                                ...
                                                                <form class="woocommerce-form woocommerce-form-login login"
                                                                    method="POST" action="{{ route('login') }}" novalidate>
                                                                    @csrf
                                                                    ...
                                                                    <p class="form-actions">
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            <a href="{{ route('forgot-password') }}">Quên
                                                                                mật khẩu?</a>
                                                                        </span>
                                                                    </p>

                                                                    <p class="form-actions-extra">Chưa có tài khoản?
            ...
            <div class="off-canvas-wrapper">
                            ...
                            <ul id="menu-main-menu-1" class="vertical menu drilldown mobile-menu" data-drilldown
                                ...
                                <li
                                    ...
                                    <ul class="menu vertical nested">
                                        ...
                                        <li
                                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1112">
                                        ...
                                        <li
                                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1644">
                                            <a href="../home-v10/index.html"><span>Home v10 — SilkSculpt</span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li
                                    class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current_page_ancestor menu-item-has-children menu-item-79">
                                    ...
                                    <ul class="menu vertical nested">
                                        ...
                                        <li
                                            class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-442">
                                            <a href="#"><span>Core Pages</span></a>
                                            <ul class="menu vertical nested">
                                                <li
                                                    class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-11 current_page_item menu-item-445">
                                                    <a href="index.html" aria-current="page"><span>My account</span></a>
                                                </li>
                                                <li
                                ...
                                <li
                                    ...
                                    <ul class="menu vertical nested">
                                        ...
                                        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-643">
                                            <a href="../blog/indexc144.html?theme_template_id=637"><span>Blog — Style
                                                    02</span></a>
                                        </li>
                                        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-652">
                                            <a href="../blog/index0f67.html?theme_template_id=646"><span>Blog — Style
                                                    03</span></a>
                                        </li>
                            ...
                            <form class="header_search_form" role="search" method="get"
                                ...
                                <div class="header_search_form_inner">
                                    <div class="header_search_input_wrapper">
                                        <input name="s" id="search_719" class="header_search_input" type="search"
                                            autocomplete="off" value="" data-min-chars="3"
                ...
                <div class="kitify-offcanvas minicart-canvas site-canvas-menu off-canvas position-right"
                    ...
                    <h2 class="title">Shopping Cart<span class="nova_js_count_bag_item_canvas count-item-canvas">6</span>
                    </h2>
