                            ...
                            <div class="site-content">
                                <div class="page-header-content">
                                    <nav class="woocommerce-breadcrumb"><a href="../../index.html">Home</a><span
                                            class="delimiter">/</span><a href="../index.html">My account</a><span
                                            class="delimiter">/</span>Lost password</nav>
                                    ...
                                    <div class="entry-content">
                                        <div class="woocommerce">
                                            ...
                                            <form method="post" class="woocommerce-ResetPassword lost_reset_password">
                                                ...
                                                <p>Quên mật khẩu? Vui lòng nhập tên người dùng hoặc địa chỉ email của
                                                    bạn.</p>
                                                <p
                                                    class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
                                                    <label for="user_login">Tên người dùng hoặc email&nbsp;<span
                                                            class="required" aria-hidden="true">*</span><span
                                                            class="screen-reader-text">Yêu cầu</span></label>
                                                ...
                                                <p class="woocommerce-form-row form-row">
                                                    ...
                                                    <button type="submit" class="woocommerce-Button button"
                                                        value="Reset password">Đặt lại mật khẩu</button>
                                                </p>

                                                <input type="hidden" id="woocommerce-lost-password-nonce"
                                                    name="woocommerce-lost-password-nonce" value="3e904af317" /><input
                        ...
                        <form class="header_search_form" role="search" method="get"
                            ...
                            <div class="header_search_form_inner">
                                <div class="header_search_input_wrapper">
                                    <input name="s" id="search_711" class="header_search_input" type="search"
