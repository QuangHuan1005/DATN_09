...
@section('content')
    ...
    <style>
        ...
        a.btn-checkout {
            display: block;
            /* d-block trong HTML cũng OK, thêm ở đây để chắc */
            width: 100%;
            margin-top: 16px !important;
            /* ép khoảng cách với bảng */
            background: #000 !important;
            /* màu đen như bạn đang dùng */
            border: none;
            padding: 12px 16px;
            border-radius: 6px;
            font-weight: 700;
                ...
                <div class="section-bg-color">
                                ...
                                <table class="table align-middle mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse(($cart ?? []) as $row)
                                            @php
                                                $lineTotal =
                                                    (float) ($row['price'] ?? 0) * (int) ($row['quantity'] ?? 0);
                                            ...
                                            <tr>
                                                <td class="pro-thumbnail">
                                                    ...
                                                    <img src="{{ $imgUrl }}" alt="{{ $row['name'] ?? 'Product' }}"
                    ...
                    <div class="row align-items-start totals-row g-4">
                        ...
                        <div class="col-lg-6">
                                    ...
                                    <tbody>
                                        ...
                                        @if ($coSanPham)
                                            ...
                                            <tr class="total">
                                                ...
                                                <td class="text-end">{{ number_format($tongGioHang + $phiVanChuyen) }}đ
                                                </td>
                                            </tr>
                                        @else
                                            <tr class="total">
                            ...
                            <a href="" class="btn-checkout d-block"
