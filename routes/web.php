...
Route::prefix('orders')->middleware('auth')->group(function () {
    ...
    Route::patch('/{id}/complete', [OrderController::class, 'complete'])->name('orders.complete');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/account/payment', [BankAccountController::class, 'index'])->name('account.bank-accounts.index');
    Route::get('/account/payment/create', [BankAccountController::class, 'create'])->name('account.bank-accounts.create');
    Route::post('/account/payment', [BankAccountController::class, 'store'])->name('account.bank-accounts.store');
    Route::delete('/account/payment/{id}', [BankAccountController::class, 'destroy'])->name('account.bank-accounts.destroy');
    Route::post('/account/payment/{id}/set-default', [BankAccountController::class, 'setDefault'])->name('account.bank-accounts.set-default');
