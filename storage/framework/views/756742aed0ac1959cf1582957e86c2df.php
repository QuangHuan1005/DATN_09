    ...
    <div class="nova-container">
      ...
      <div class="nova-login-wrapper no_popup" style="display:flex; justify-content:center;">
        <div id="nova-register-form" style="width:100%; max-width:420px;">
          ...
          <form method="POST" action="<?php echo e(route('register')); ?>" class="woocommerce-form woocommerce-form-register register">
            <?php echo csrf_field(); ?>

            <p class="woocommerce-form-row form-row form-row-wide">
              <input type="text" name="name" id="reg_name"
                     class="woocommerce-Input woocommerce-Input--text input-text"
                     placeholder="Họ tên" value="<?php echo e(old('name')); ?>" required autocomplete="name">
            </p>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DATN_09\resources\views/auth/register.blade.php ENDPATH**/ ?>