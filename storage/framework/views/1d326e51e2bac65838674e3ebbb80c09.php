                                    ...
                                    <div class="elementor-element elementor-element-2943964 elementor-widget kitify elementor-kitify-contactform7"
                                        ...
                                        <div class="elementor-widget-container">
                                            ...
                                            <div class="wpcf7" id="wpcf7-f13-p70-o1" lang="en-US" dir="ltr"
                                                ...
                                                <?php endif; ?>
                                                <form action="<?php echo e(route('contact.store')); ?>" method="POST"  novalidate="novalidate" class="wpcf7-form init" aria-label="Contact form">
                                                    <?php echo csrf_field(); ?>
                                                    <p>
                                                        <?php $__errorArgs = ['your-name'];
...
unset($__errorArgs, $__bag); ?>
                                                        <input class="wpcf7-form-control wpcf7-text" size="40" maxlength="255" placeholder="Tên của bạn (Bắt buộc)" autocomplete="name" type="text" name="your-name" value="<?php echo e(old('your-name')); ?>">
                                                        <br>
                                                        <?php $__errorArgs = ['your-email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    <input class="wpcf7-form-control wpcf7-email" size="40" maxlength="255" placeholder="Email của bạn (Bắt buộc)" autocomplete="email" type="email" name="your-email" value="<?php echo e(old('your-email')); ?>">
                                                        <br>
                                                    <?php $__errorArgs = ['your-subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    <input class="wpcf7-form-control" size="40" maxlength="255" placeholder="Tiêu đề (Bắt buộc)" type="text" name="your-subject" value="<?php echo e(old('your-subject')); ?>">
                                                        <br>
                                                    <?php $__errorArgs = ['your-message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    <textarea class="wpcf7-form-control wpcf7-textarea" cols="40" rows="10" maxlength="2000" placeholder="Nội dung (Tùy chọn)" name="your-message"><?php echo e(old('your-message')); ?></textarea>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\DATN09\resources\views/contact/index.blade.php ENDPATH**/ ?>