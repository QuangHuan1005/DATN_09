            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center gap-1">
                        ...
                        <form method="GET" action="<?php echo e(route('admin.orders.index')); ?>" class="search-bar me-3">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="<?php echo e(route('admin.orders.index', ['status' => null])); ?>" class="dropdown-item">Tất cả
                                    trạng
                                    thái</a>
                                <a href="<?php echo e(route('admin.orders.index', ['status' => 1])); ?>" class="dropdown-item">Chờ xác
                                    nhận</a>
                                <a href="<?php echo e(route('admin.orders.index', ['status' => 2])); ?>" class="dropdown-item">Xác
                                    nhận</a>
                                <a href="<?php echo e(route('admin.orders.index', ['status' => 3])); ?>" class="dropdown-item">Đang giao
                                    hàng</a>
                                <a href="<?php echo e(route('admin.orders.index', ['status' => 4])); ?>" class="dropdown-item">Đã giao
                                    hàng</a>
                                <a href="<?php echo e(route('admin.orders.index', ['status' => 5])); ?>" class="dropdown-item">Hoàn
                                    thành</a>
                                <a href="<?php echo e(route('admin.orders.index', ['status' => 6])); ?>" class="dropdown-item">Hủy</a>
                                <a href="<?php echo e(route('admin.orders.index', ['status' => 7])); ?>" class="dropdown-item">Hoàn
                                    hàng</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.users.show', $order->user_id ?? 0)); ?>"
