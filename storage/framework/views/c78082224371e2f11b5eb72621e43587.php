    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('admin.users.update', $user->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="is_locked" name="is_locked" value="1"
                    <?php echo e($user->is_locked ? 'checked' : ''); ?>>
            ...
            <?php if($user->image): ?>
                <div class="mb-3">
                    <img src="<?php echo e(asset('uploads/users/' . $user->image)); ?>" alt="Ảnh đại diện" style="max-width: 150px;"
                        class="img-thumbnail">
                </div>
            <?php endif; ?>
