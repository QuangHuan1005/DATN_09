...
<div class="container-xxl">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <form method="GET" action="<?php echo e(route('staff.orders.index')); ?>" class="d-flex">
        ...
        <div class="col-md-6 text-end">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a href="<?php echo e(route('staff.orders.index')); ?>" class="dropdown-item">Tất cả trạng thái</a>
                    <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('staff.orders.index', ['status' => $status->id])); ?>" class="dropdown-item">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('staff.orders.show', $order->user_id ?? 0)); ?>" class="link-primary">
                                ...
                                <td>
                                    <form action="<?php echo e(route('staff.orders.status', $order->id)); ?>" method="POST" class="status-form">
                                        <?php echo csrf_field(); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td>
                                    <a href="<?php echo e(route('staff.orders.show', $order->id)); ?>" class="btn btn-soft-info btn-sm" title="Xem chi tiết">
