                            ...
                            <nav class="main-navigation header-primary-nav">
                                <ul id="menu-main-menu" class="menu nav-menu">
                                    ...
                                    <li id="menu-item-77"
                                        ...
                                        <a href="<?php echo e(route('blog.index')); ?>"><span>Tin tức</span></a>
                                    </li>
                                    <li id="menu-item-84"
                ...
                <div class="elementor-element elementor-element-16239ba6 elementor-hidden-mobile elementor-view-default elementor-widget elementor-widget-icon"
                    ...
                    <div class="elementor-widget-container">
                        <div class="elementor-icon-wrapper">
                            <a class="elementor-icon" href="<?php echo e(route('wishlist.index')); ?>" title="Wishlist">
...
<?php /**PATH C:\laragon\www\DATN_09-main\resources\views/layouts/header.blade.php ENDPATH**/ ?>