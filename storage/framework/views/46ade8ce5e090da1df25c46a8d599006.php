    ...
    <header class="woocommerce-archive-header">
        <div class="woocommerce-archive-header-inside">
            <p class="woocommerce-result-count">
                Hiển thị <?php echo e($products->firstItem()); ?>&ndash;<?php echo e($products->lastItem()); ?> / <?php echo e($products->total()); ?> kết quả
            </p>
            <div class="woocommerce-archive-toolbar sh--color">
                ...
                <form class="woocommerce-ordering" method="get" action="<?php echo e(route('products.index')); ?>">
                    ...
                    <?php $__currentLoopData = request()->except(['sort', 'paged', 'page']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(is_array($val)): ?>
                    ...
                    <select name="sort" class="orderby" id="sort" aria-label="Shop order" onchange="this.form.submit()">
                        <option value="default" <?php echo e(request('sort') == 'default' ? 'selected' : ''); ?>>Mặc định</option>
...
</div><?php /**PATH C:\laragon\www\DATN09\resources\views/products/partials/toolbar.blade.php ENDPATH**/ ?>