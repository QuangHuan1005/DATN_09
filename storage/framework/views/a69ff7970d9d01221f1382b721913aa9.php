        ...
        <div class="e-con-inner">
                        ...
                        <ul class="elementor-icon-list-items">
                            ...
                            <li class="elementor-icon-list-item">
                                <a href="../cart/index.html">
                                    ...
                                    <span class="elementor-icon-list-text">Sứ mệnh & Giá trị</span>
                                </a>
                            </li>
                            <li class="elementor-icon-list-item">
                                <a href="../wishlist/index.html">

                                    <span class="elementor-icon-list-text">Gặp gỡ đội ngũ</span>
                                </a>
                            </li>
                            <li class="elementor-icon-list-item">
                                <a href="../wishlist/index.html">

                                    <span class="elementor-icon-list-text">Nỗ lực bền vững</span>
                                </a>
                            </li>
                            <li class="elementor-icon-list-item">
                                <a href="../faqs/index.html">

                                    <span class="elementor-icon-list-text">Đối tác thương hiệu</span>
                                </a>
                            </li>
                            <li class="elementor-icon-list-item">
                                <a href="../faqs/index.html">

                                    <span class="elementor-icon-list-text">Hợp tác với người có ảnh hưởng</span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="elementor-element elementor-element-16032d9e e-con-full e-flex kitify-col-width-auto-no ignore-docs-style-no kitify-disable-relative-no e-con e-child"
                ...
                <div class="elementor-element elementor-element-4d7c4cfe elementor-widget elementor-widget-heading"
                    ...
                    <div class="elementor-widget-container">
                        <h3 class="elementor-heading-title elementor-size-default">Khả năng tiếp cận</h3>
                    </div>
                </div>
                        ...
                        <ul class="elementor-icon-list-items">
                            <li class="elementor-icon-list-item">
                                <a href="../my-account/index.html">
                                    ...
                                    <span class="elementor-icon-list-text">Tuyên bố khả năng tiếp cận</span>
                                </a>
                            </li>
                            <li class="elementor-icon-list-item">
                                <a href="../cart/index.html">
                            ...
                            <li class="elementor-icon-list-item">
                                <a href="../wishlist/index.html">
                                    ...
                                    <span class="elementor-icon-list-text">Tùy chọn khả năng tiếp cận web</span>
                                </a>
                            </li>
                            <li class="elementor-icon-list-item">
                                <a href="../wishlist/index.html">

                                    <span class="elementor-icon-list-text">Tuân thủ ADA</span>
                                </a>
                            </li>
                            <li class="elementor-icon-list-item">
                                <a href="../wishlist/index.html">
            ...
            <div class="elementor-element elementor-element-31de1b1 e-con-full e-flex kitify-col-width-auto-no ignore-docs-style-no kitify-disable-relative-no e-con e-child"
                ...
                <div class="elementor-element elementor-element-7362d692 elementor-widget elementor-widget-heading"
                    ...
                    <div class="elementor-widget-container">
                        <h3 class="elementor-heading-title elementor-size-default">Tham gia cộng đồng của chúng tôi
                        </h3>
                    </div>
                </div>
                        ...
                        <ul class="elementor-icon-list-items">
                            <li class="elementor-icon-list-item">
                                <a href="../about-us/index.html">
                                    ...
                                    <span class="elementor-icon-list-text">Thành viên VIP</span>
                                </a>
                            </li>
                            <li class="elementor-icon-list-item">
                                <a href="../cart/index.html">
                            ...
                            <li class="elementor-icon-list-item">
                                <a href="../wishlist/index.html">
                                    ...
                                    <span class="elementor-icon-list-text">Đánh giá của khách hàng</span>
                                </a>
                            </li>
                            <li class="elementor-icon-list-item">
                                <a href="../wishlist/index.html">

                                    <span class="elementor-icon-list-text">Diễn đàn phong cách</span>
                                </a>
                            </li>
                            <li class="elementor-icon-list-item">
                                <a href="../wishlist/index.html">
                            ...
                            <li class="elementor-icon-list-item">
                                <a href="../wishlist/index.html">
                                    ...
                                    <span class="elementor-icon-list-text">Văn hóa và Giá trị</span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="elementor-element elementor-element-76773236 e-con-full e-flex kitify-col-width-auto-no ignore-docs-style-no kitify-disable-relative-no e-con e-child"
                ...
                <div class="elementor-element elementor-element-dd4dd2b elementor-widget elementor-widget-heading"
                    ...
                    <div class="elementor-widget-container">
                        <h2 class="elementor-heading-title elementor-size-default">Hãy liên hệ với chúng tôi</h2>
                    </div>
                </div>
                ...
                <div class="elementor-element elementor-element-6e184175 elementor-widget kitify elementor-kitify-subscribe-form"
                    data-id="6e184175" data-element_type="widget" data-widget_type="kitify-subscribe-form.default">
                    <div class="elementor-widget-container">
                            ...
                            <form method="POST" action="#" class="kitify-subscribe-form__form">
                                <div class="kitify-subscribe-form__input-group">
                                    <div class="kitify-subscribe-form__fields">
                                        <input class="kitify-subscribe-form__input kitify-subscribe-form__mail-field"
                        ...
                        <ul class="menu vertical nested">
                            <li
                                ...
                                <ul class="menu vertical nested">
                                    ...
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-375">
                                        <a href="../shop/index9a6d.html?theme_template_id=371"><span>Shop — No
                                                Sidebar</span></a>
                                    </li>
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-382">
                    ...
                    <div class="header_search_form_inner">
                        <div class="header_search_input_wrapper">
                            <input name="keyword" id="search_548" class="header_search_input" type="search"
                                autocomplete="off" value="<?php echo e(request('keyword')); ?>" data-min-chars="3"
        ...
        <defs>
            ...
            <symbol id="mixtas-button-arrow" viewBox="0 0 24 24">
                <g class="nc-icon-wrapper" stroke-linecap="square" stroke-linejoin="miter" stroke-width="2"
                    ...
                    <line data-cap="butt" data-color="color-2" fill="none" stroke-miterlimit="10" x1="2"
                        y1="12" x2="22" y2="12" stroke-linecap="butt" />
...
<?php /**PATH C:\laragon\www\DATN_09-main\resources\views/layouts/footer.blade.php ENDPATH**/ ?>