                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div
                                                                ...
                                                                <?php if($line->image): ?>
                                                                    <img src="<?php echo e(asset('storage/' . $line->image)); ?>"
                                                            ...
                                                            <div>
                                                                <a href="#!"
                                                                    class="text-dark fw-medium fs-15"><?php echo e($line->product_name); ?></a>
                                                                <p class="text-muted mb-0 mt-1 fs-13">
                                                                    <span><?php echo e($line->variant_text ?? '-'); ?></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td><?php echo e(number_format($line->unit_price, 0, ',', '.')); ?>₫</td>
                                                    <td> <?php echo e($line->qty); ?></td>
                                                    <td><?php echo e(number_format($line->line_total, 0, ',', '.')); ?>₫</td>
...
<?php echo $__env->make('admin.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\DATN_09-main\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>