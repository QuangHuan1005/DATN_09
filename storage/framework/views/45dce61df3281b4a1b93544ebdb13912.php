<div class="main-nav">
    ...
    <div class="scrollbar" data-simplebar>
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
    <a class="nav-link" href="#" role="button" aria-expanded="false" aria-controls="sidebarProducts">
        <span class="nav-icon">
        ...
        <span class="nav-text"> Quản Lý Sản Phẩm </span>
            ...
            <li class="nav-item">
               <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('staff.inventory.*') ? 'active' : ''); ?>"
                href="#">
                    <span class="nav-icon">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('staff.orders.index')); ?>" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link" href="#sidebarRoles" role="button" aria-expanded="false"
                    aria-controls="sidebarRoles">
                    <span class="nav-icon">
                        <iconify-icon icon="solar:user-speak-rounded-bold-duotone"></iconify-icon>
                    </span>
                    <span class="nav-text"> Quản Lý Vai Trò </span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="#sidebarSellers" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link" href="#sidebarCoupons" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link" href="#sidebarPages" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link" href="#sidebarAuthentication" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link" href="#sidebarBaseUI" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarExtendedUI" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarCharts" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarForms" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarTables" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarIcons" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarMaps" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarMultiLevelDemo" role="button" aria-expanded="false"
                ...
                <div class="collapse" id="sidebarMultiLevelDemo">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link  menu-arrow" href="#sidebarItemDemoSubItem" role="button"
                                aria-expanded="false" aria-controls="sidebarItemDemoSubItem">
