...
<main id="main" class="site-main">
    <div class="container">
        <div class="cart pt-40 checkout">
            <form action="<?php echo e(route('checkout.store')); ?>" method="post" enctype="application/x-www-form-urlencoded">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-12 col-2xl-7 pb-3">
                                    ...
                                    <div class="block-border address-default">
                                        ...
                                        <h4><?php echo e($user->name ?? 'Khách hàng'); ?>
                                        ...
                                        <label class="ds__item">
                                            ...
                                            <span class="ds__item__label">Chuyển phát nhanh
                                                <span class="delivery-time">
                                                    Thời gian giao hàng dự kiến: <?php echo e(date('l, d/m/Y', strtotime('+3 days'))); ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="cart-sale-price">
                                                <?php if($item['variant']->sale > 0): ?>
                                                    -<?php echo e(number_format($item['variant']->sale)); ?>đ
                                                <?php endif; ?>
                                            </td>
                                            <td>
                        ...
                        <div class="cart-summary">
                            <div id="box_product_total">
                                <div class="cart-summary__overview">
                                    ...
                                    <div class="cart-summary__overview__item">
                                        <p>Tiền thanh toán</p>
                                        <p><b><?php echo e(number_format($totalAmount)); ?>đ</b></p>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\DATN_09\resources\views/checkout/index.blade.php ENDPATH**/ ?>