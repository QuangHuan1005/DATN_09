                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <input type="checkbox" id="<?php echo e($inputId); ?>" class="btn-check"
                                                    name="size_ids[]" value="<?php echo e($size->id); ?>"
                                                    <?php echo e(is_array(old('size_ids')) && in_array($size->id, old('size_ids')) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <input type="checkbox" id="<?php echo e($colorInputId); ?>" class="btn-check"
                                                    name="color_ids[]" value="<?php echo e($color->id); ?>"
                                                    <?php echo e(is_array(old('color_ids')) && in_array($color->id, old('color_ids')) ? 'checked' : ''); ?>>
                                                ...
                                                <label
                                                    ...
                                                    <i class="bx bxs-circle fs-18"
                                                        style="color: <?php echo e($color->color_code); ?>"></i>
                                                </label>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DATN_09\resources\views/admin/products/create.blade.php ENDPATH**/ ?>