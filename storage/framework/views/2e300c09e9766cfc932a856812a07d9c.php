<!-- Vendor Javascript (Require in all Page) -->
    ...
    <!-- Dashboard Js -->
    <script src="<?php echo e(asset('assets/js/pages/dashboard.js')); ?>"></script><?php /**PATH C:\laragon\www\DATN_09-main\resources\views/admin/layouts/js.blade.php ENDPATH**/ ?>